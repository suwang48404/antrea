...
func (in *AddressGroup) DeepCopyInto(out *AddressGroup) {
	*out = *in
	...
	if in.ExternalEntities != nil {
		in, out := &in.ExternalEntities, &out.ExternalEntities
		*out = make([]GroupMemberExternalEntity, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AddressGroupPatch) DeepCopyInto(out *AddressGroupPatch) {
	*out = *in
	...
	if in.AddedExternalEntities != nil {
		in, out := &in.AddedExternalEntities, &out.AddedExternalEntities
		*out = make([]GroupMemberExternalEntity, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RemovedExternalEntities != nil {
		in, out := &in.RemovedExternalEntities, &out.RemovedExternalEntities
		*out = make([]GroupMemberExternalEntity, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GroupMemberExternalEntity) DeepCopyInto(out *GroupMemberExternalEntity) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GroupMemberExternalEntity.
func (in *GroupMemberExternalEntity) DeepCopy() *GroupMemberExternalEntity {
	if in == nil {
		return nil
	}
	out := new(GroupMemberExternalEntity)
	in.DeepCopyInto(out)
	return out
}
